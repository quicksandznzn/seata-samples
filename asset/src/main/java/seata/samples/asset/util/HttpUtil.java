package seata.samples.asset.util;
...
public class HttpUtil {
    ...
    public static final ContentType TEXT_PLAIN = ContentType
        .create("text/plain", Charset.forName("utf-8"));
     ...
     * @throws Exception IO流异常
     */
    public static String httpPostForm(String url, String name, String pathName,
     ...
     * @throws Exception IO流异常
     */
    public static String httpPostForm(String url, String name, File file, Map<String, Object> map)
        throws Exception {
        // 初始化请求链接
        HttpPost httppost = new HttpPost(url);
    ...
    public static String getQueryStr(Map<String, Object> params) throws Exception {
        return URLEncodedUtils.format(covertParams2NVPS(params), Charset.forName("utf-8"));
    }
    ...
    public static <T> T parseNVPS2Bean(String queryStr, Class<T> clazz) throws Exception {
        ...
        List<NameValuePair> list = URLEncodedUtils.parse(queryStr, Charset.forName("utf-8"));
     ...
     * <p>使用指定的证书文件及密码</p>
     */
    private static String doHttps(HttpRequestBase request, String path, String password)
        throws Exception {
        // 获取HTTPS SSL证书
